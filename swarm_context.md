...
Current Version: v0.23.0 (Stateful Smart Contracts & P2P Sync).
​2. Core Tech Stack
...
​swarm-node: Modular architecture split into main.rs, gateway.rs, worker.rs, and types.rs. Handles P2P state synchronization and atomic routing.
